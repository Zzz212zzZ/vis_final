...
<script>
    ...
    const DEFAULT_CENTER = [105.11, 28.10]
                    ...
                    baseOption: {
                        ...
                        visualMap: [
                        {
                            ...
                            pieces: [{
                                ...
                                lte: 10000,
                                label: "5000 - 10000 人",
                                color: "rgb(71,158,180)"
                            }, {
                                gte: 200,
                                lt: 5000,
                                label: "200 - 5000 人",
                                color: "rgb(136,208,166)"
                            }, {
                                gt: 0,
                                lt: 200,
                                label: "0 - 200人",
                                color: "rgb(203,233,158)"
                            }, {
                                value: 0,
